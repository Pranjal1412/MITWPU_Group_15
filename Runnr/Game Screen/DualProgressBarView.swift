...
final class DualProgressBarView: UIView {
    ...
    var maxValue: CGFloat = 10 { didSet { updateBars() } }
    var leftValue: CGFloat = 0 { didSet { updateBars() } }
    var rightValue: CGFloat = 0 { didSet { updateBars() } }
